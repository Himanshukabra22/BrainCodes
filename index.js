...
function slide()
{
    if(a%2 == 0)
    {
        ...
        document.getElementById("aboutevent").style.transition="0.2s"
        document.getElementById("notiposterid").style.width="35rem"
        document.getElementById("notiposterid").style.height="15rem"
        document.getElementById("aboutevent").style.transform="rotate(180deg)"
        a++
    }
    else
    {
        ...
        document.getElementById("aboutevent").style.transform="rotate(0deg)"
        a--;
    }
}