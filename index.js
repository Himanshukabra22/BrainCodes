...
var partlinks = ["./content/logo1.jpg","./content/logo2.jpg","./content/logo3.jpg","./content/logo4.jpg","./content/logo5.jpg","./content/logo6.jpg"]
var i = 0;
function myfunction() {
    if (i == 0) {
...
function evinfo() {
    ...
    document.getElementById("tplinks").href = partlinks[i];
}
function nextevent() {
...
function addevent()
{
    ...
    var l = partlinks.push(document.getElementById("plink").value)
    partlinks.push(l)
    partlinks.pop()
